...
const scenarios = [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "Strawberry", percentage: 18, keywords: ["strawberry"] },
            { text: "Mint Chocolate Chip", percentage: 15, keywords: ["mint"] },
            { text: "Cookies and Cream", percentage: 10, keywords: ["cookies", "cream"] },
            { text: "Rocky Road", percentage: 7, keywords: ["rocky", "road"] },
            { text: "Pistachio", percentage: 3, keywords: ["pistachio"] },
            { text: "Coffee", percentage: 9, keywords: ["coffee"] },
        ],
    },
    {
        ...
        answers: [
            ...
            { text: "Try local food", percentage: 21, keywords: ["food", "cuisine", "restaurants"] },
            { text: "Take photos", percentage: 20, keywords: ["photo", "photos", "photography"] },
            { text: "Go shopping", percentage: 16, keywords: ["shopping", "spend money", "souvenirs"] },
            { text: "Visit attractions", percentage: 7, keywords: ["sightseeing", "tours", "landmarks", "landmark", "tour", "attractions"] },
        ],
    },
    {
        question: "Name a popular type of cuisine that people enjoy",
        answers: [
            { text: "Italian", percentage: 23, keywords: ["italian"] },
            { text: "Mexican", percentage: 20, keywords: ["mexican"] },
            { text: "Chinese", percentage: 21, keywords: ["chinese"] },
            { text: "American", percentage: 20, keywords: ["american"] },
        ],
    },
    {
        ...
        answers: [
            ...
            { text: "Building sandcastles", percentage: 21, keywords: ["sandcastles"] },
            { text: "Picnics", percentage: 20, keywords: ["picnics", "picnicking", "picnic"] },
        ],
    },
    {
        question: "Name something someone might have in the bathroom",
        answers: [
            { text: "Toothbrush", percentage: 23, keywords: ["toothbrush"] },
            { text: "Shampoo", percentage: 20, keywords: ["shampoo"] },
            { text: "Soap", percentage: 21, keywords: ["soap"] },
            { text: "Toothpaste", percentage: 20, keywords: ["toothpaste"] },
            { text: "Razor", percentage: 20, keywords: ["razor"] },
        ],
    },
    {
        ...
        answers: [
            { text: "Watch TV/movies", percentage: 27, keywords: ["TV", "movie", "television", "movies", "video", "videos"] },
            { text: "Read a book", percentage: 20, keywords: ["read", "book", "novel", "magazine", "newspaper"] },
            { text: "Cook a Meal", percentage: 21, keywords: ["cook"] },
            { text: "Sleep In", percentage: 20, keywords: ["sleep", "sleeping"] },
            { text: "Go for a walk", percentage: 15, keywords: ["walk", "run", "stroll", "hike", "jog"] },
        ],
    },
];
